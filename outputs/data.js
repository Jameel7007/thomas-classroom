// English Curriculum Map — CEFR A0 → B2
// Content is an original synthesis of standard CEFR can-do descriptors and
// common course grammar/vocabulary scope-and-sequence.
...
window.CURRICULUM = [
  {
    ...
    gse: "10–21",
    blurb:
      "The very first contact with English. Learners build the alphabet, sounds, numbers and a handful of survival phrases — enough to say who they are and exchange a few words.",
    canDo: [
  ...
  },
  {
    ...
    gse: "22–29",
    blurb:
      "Learners can handle the basics of daily life. They talk about routines, possessions and immediate needs using simple present-tense structures, if the other person speaks slowly and clearly.",
    canDo: [
    ...
    grammar: [
      "Present simple (all forms, do / does)",
      "Present continuous",
      "there is / there are",
      "have got",
  ...
  },
  {
    ...
    gse: "30–42",
    blurb:
      "Learners cope with routine tasks and exchanges. They can talk about the past and the future, compare things, and describe their background and immediate environment in short connected sentences.",
    canDo: [
  ...
  },
  {
    ...
    gse: "43–58",
    blurb:
      "The independent-user threshold. Learners deal with most situations while travelling, produce connected text on familiar topics, and explain their opinions, plans and experiences.",
    canDo: [
    ...
    grammar: [
      ...
      "Modals of deduction: might, could, must",
      "Question tags",
      "Gerunds vs infinitives",
      "Future review: will / going to / present continuous",
    ],
    vocab: [
      "Work & careers",
      "Environment & nature",
  ...
  },
  {
    ...
    grammar: [
      ...
      "Full passive (all tenses, passive reporting)",
      "Reported speech (questions, commands, reporting verbs)",
      "Non-defining relative clauses",
      "Modals of past speculation (must have, can't have)",
      "wish / if only",
    ...
    vocab: [
      "Abstract & academic topics",
      "Politics & global issues",
      "Science & innovation",
      "Idioms & fixed expressions",
      "Register & formality",
      "Nuanced adjectives & intensifiers",
